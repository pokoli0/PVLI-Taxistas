...
import escenaFinal from './escenaFinal.js';
    ...
    let config = {
        ...
        height: 500,      
        pixelArt: true,
        scene:[Boot,Menu,MenuDias,escenaControles,Shop,Radio,ControlLevels, Level1,Level2,Level3, conversacionLvl1, LoadConversacionScene, escenaDecision, escenaFinal],
        physics: {
            default: 'arcade',
            arcade: {
                debug: false
